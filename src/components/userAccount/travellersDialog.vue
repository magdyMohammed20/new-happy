<template>
  <!-- get all travellers -->
  <el-dialog
    v-model="travellersDialog"
    title="Your Travellers"
    :close-on-press-escape="false"
    :draggable="true"
    :destroy-on-close="true"
    @close="SET_TRAVELLERS_DIALOG(false)"
    :close-on-click-modal="false"
    class="sm:w-full md:w-[100%] lg:w-[90%] custom-border"
  >
    <div class>
      <el-button
        type="primary"
    ...
    <el-table :data="travellers" style="width: 100%">
